  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <h2 className="text-2xl sm:text-3xl font-bold text-gray-800 mb-6">My Sales</h2>

        {orders.length === 0 ? (
          <div className="bg-white rounded-lg shadow-md p-6 sm:p-12 text-center">
            <p className="text-gray-900 mb-4">You haven&apos;t received any orders yet.</p>
            <Link
                ...
                <div className="border-t pt-4 mt-4">
                  <div className="grid md:grid-cols-2 gap-4 text-sm">
                    <div>
                      ...
                      <div className="text-gray-900">{order.buyer.address}</div>
                      <div className="text-gray-900">{order.buyer.phoneNumber}</div>
                    </div>
                    <div>
